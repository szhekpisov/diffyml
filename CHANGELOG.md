...
- Add inverse diff (--unchanged) to report equal values (#184) ([#184](https://github.com/szhekpisov/diffyml/pull/184))
...
- Add Windows build targets to goreleaser (#181) ([#181](https://github.com/szhekpisov/diffyml/pull/181))
...
- Add .deb/.rpm/.apk Linux packages with SBOMs (#145) ([#145](https://github.com/szhekpisov/diffyml/pull/145))
