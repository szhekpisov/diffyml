...
1,300+ tests (unit, e2e, fuzz, property-based), 99.9% code coverage, 100% [mutation testing](https://github.com/go-gremlins/gremlins) efficacy. CI enforces a 99% coverage floor.
