...
func (c *CLIConfig) initFlags() {
	...
	c.fs.BoolVar(&c.LineNumbers, "l", c.LineNumbers, "")
	c.fs.BoolVar(&c.LineNumbers, "line-numbers", c.LineNumbers, "show source line numbers for each difference")
...
func (c *CLIConfig) Usage() string {
	...
	sb.WriteString("  -l, --line-numbers                  show source line numbers for each difference\n")
